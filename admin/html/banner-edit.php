...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form-article-add" ENCTYPE="multipart/form-data" method= "post" action= "../php/banner-edit.php">
        <input type="hidden" name="id" id="idd">
        <?php 
                $id=$_GET['id'];
                require("../php/Code/JXMySQL.php");
                JXMySQL_Execute("select * from `shi-banner` where id = ?",array($id));
                $list=JXMySQL_Result();
                foreach ($list as $k => $v) {
                 ?>
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <img src="<?php echo $v['banner']?>" alt="" width="200px" height="100px">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>修改头像：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="file"  value="" placeholder="" id="banner" name="banner">
        </div>
    </div>
    <div class="row cl">

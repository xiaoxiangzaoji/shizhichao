...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form-article-add" onsubmit="return tijiao();" ENCTYPE="multipart/form-data" method= "post" action= "../php/audio-add.php">
    ...
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>文件：</label><span style="color:red;">如果不能播放请修改文件名格式为数字后者字母加.mp3</span>

...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form-article-add" onsumit=" return tijiao();" ENCTYPE="multipart/form-data" method= "post" action= "../php/vedio-add.php">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
          ...
          $id = $_GET['id'];
          ?>
            <input  type="hidden" class="input-text" value="<?php echo $id; ?>" placeholder="" id="author" name="author" onfocus="get()" onblur="check()" style="width:200px"><input type="text" id="check1" style="display:none;float:right;">

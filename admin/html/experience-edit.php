...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form-article-add" onsubmit="tijiao();" ENCTYPE="multipart/form-data" method= "post" action= "../php/experience-edit.php">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
            <input  type="text" class="input-text" value="<?php echo $v['title'] ?>" placeholder="" id="adminName" name="adminName" onfocus="get()" onblur="check()" style="width:200px"><input type="text" id="check1" style="display:none;float:right;">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>发布人：</label>
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
            <input  type="text" class="input-text" value="<?php echo $v['nickname'] ?>" placeholder="" id="nickname" name="nickname"  style="width:200px">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>作者：</label>
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
            <input  type="text" class="input-text" value="<?php echo $v['author'] ?>" placeholder="" id="author" name="author" onfocus="getauthor()" onblur="checkauthor()" style="width:200px"><input type="text" id="check2" style="display:none;float:right;">
        </div>
    </div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
            <input  type="text" class="input-text" value="<?php echo $v['stars'] ?>" placeholder="" id="stars" name="stars" onfocus="getstars()" onblur="checkstars()" style="width:200px"><input type="text" id="check3" style="display:none;float:right;">
        </div>
    </div>
    <div class="row cl">

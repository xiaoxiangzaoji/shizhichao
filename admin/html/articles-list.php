...
<div class="page-container">
	...
	<span class="l"><a  style="text-decoration:none href="javascript:;" onclick="this,del_()"  class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a></span> <span style="margin-left: 4px;"><a class="btn btn-primary radius" data-title="添加文章" data-href="article-add.php" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加文章</a></span><span class="r">共有数据：<strong><?php   require("../php/config.php"); $res=mysql_query("select count(*) as total from `shi-article` "); if($row=mysql_fetch_array($res)){ $num=$row['total'];}  echo $num;?></strong> 条</span> </div>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<?php 
            	...
            	JXMySQL_Execute("select a.id,title,time,read_num,course,author,Schools,y.years,ea.area,stars from `shi-article` as a
								LEFT JOIN `shi-course` as c
								on a.categroy = c.id
								LEFT JOIN `shi-arschool` as ar 
								on a.school= ar.id
								LEFT JOIN `shi-aryears` as y
								on a.years = y.id
								LEFT JOIN `shi-ararea` as ea 
								on a.area =ea.id");
            	$list=JXMySQL_Result();
                ...
                <tr class="text-c">
	                ...
	                <td class="f-14 td-manage"> <a style="text-decoration:none" class="ml-5" onClick="article_edit('招商信息编辑','articles-edit.php','<?php  echo $v['id']; ?>')" href="articles-edit.php?id=<?php  echo $v['id']; ?>"   title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="article_del(this,'<?php  echo $v['id'] ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                </tr>
                 <?php } ?>
			</tbody>
		</table>

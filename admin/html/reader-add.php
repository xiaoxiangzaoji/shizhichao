...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form-article-add" onsubmit="checkinfo()" ENCTYPE="multipart/form-data" method= "post" action= "../php/reader-add.php" >
    ...
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>朗读者：</label>

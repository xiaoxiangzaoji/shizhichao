...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form-article-add" onsubmit=" return tijiao();" ENCTYPE="multipart/form-data" method= "post" action= "../php/vedio-add.php">
        ...
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
            ...
            <?php 
                ...
                foreach ($lista as $k => $va) {
                 ?>
                 <option value="<?php echo $va['id'] ?>"><?php echo $va['teachername'] ?></option>
                 <?php } ?>
                 </select>

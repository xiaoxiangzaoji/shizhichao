...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form-article-add" ENCTYPE="multipart/form-data" method= "post" action= "../php/customers-edit.php">
        <input type="hidden" name="id" id="idd">
        <?php 
                $id=$_GET['id'];
                require("../php/Code/JXMySQL.php");
                JXMySQL_Execute("select * from `shi-custmoer` where id = ?",array($id));
                $list=JXMySQL_Result();
                foreach ($list as $k => $v) {
                 ?>
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <img src="<?php echo $v['headimg']?>" alt="" width="200px" height="100px">
        </div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
            <input  type="text" class="input-text" value="<?php echo $v['nickname'] ?>" placeholder="" id="adminName" name="adminName" onfocus="get()" onblur="check()" style="width:200px"><input type="text" id="check1" style="display:none;float:right;">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>密码：</label>
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
            <input type="password" class="input-text" value="<?php echo $v['password'] ?>" placeholder="" id="password" name="password" onfocus="getpass()" onblur="checkpass()" style="width:200px"><input type="text" id="check2" style="display:none;float:right;">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>电话：</label>
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
            <input type="text" class="input-text" value="<?php echo $v['phone'] ?>" placeholder="" id="phone" name="phone" onfocus="getphone()" onblur="checkphone()" style="width:200px"><input type="text" id="check3" style="display:none;float:right;">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>地址：</label>
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
            <input type="text" class="input-text" value="<?php echo $v['address'] ?>" placeholder="" id="address" name="address">
        </div>
    </div>
    <div class="row cl">

...
<article class="page-container">
    ...
    <form class="form form-horizontal" id="form-article-add" ENCTYPE="multipart/form-data" method= "post" action= "../php/reader-edit.php">
        <input type="hidden" name="id" id="idd">
        <?php 
                $id=$_GET['id'];
                require("../php/Code/JXMySQL.php");
                JXMySQL_Execute("select * from `shi-reader` where id = ?",array($id));
                $list=JXMySQL_Result();
                foreach ($list as $k => $v) {
                 ?>
    <div class="row cl">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9" style="width:400px;">
            <input  type="text" class="input-text" value="<?php echo $v['teacher'] ?>" placeholder="" id="adminName" name="adminName" style="width:200px">
        </div>
    </div>
    <div class="row cl">
